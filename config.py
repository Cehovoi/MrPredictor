...
class ProductionConfigPostgres(BaseConfig):
    DEBUG = False
    SQLALCHEMY_DATABASE_URI = os.environ.get('DEVELOPMENT_DATABASE_URI') or \
                              "postgres://splmwtmlfpydec:08c251c0332480445243a388f76f46b2cfd787b4116aa4e5750b0718f6a3fdca@ec2-54-74-60-70.eu-west-1.compute.amazonaws.com:5432/dbvaoqla3vesf9"
